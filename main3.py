...
class MedlinePlusVectorizer:
    ...
    def __init__(
        ...
        self.openai_client = OpenAI(api_key=os.getenv("OPENAI_API_KEY"))  # Ensure OPENAI_API_KEY is set in your environment
    
    # ... (rest of the methods remain unchanged until query_with_openai)
    ...
    def generate_openai_response(self, query: str, context: str) -> str:
        ...
        response = self.openai_client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": "You are a medical assistant. Give an answer to the question strictly based on the given context. If the answer is unclear, state so."},
